...
var ajaxCart = (function(module, $) {
  ...
  buildCart = function (cart) {
    ...
    // Show empty cart
    if (cart.item_count === 0) {
      $cartContainer.append('<p>' + "Su carrito actualmente está vacío." + '</p><a href="/collections/all" class="btn btn-default btn-large">' + "Continúe explorando \u003ca href=\"\/collections\/all\"\u003eaquí\u003c\/a\u003e." + '</a>');
      cartCallback(cart);
      return;
    }
